...
window.onload= function(){
    ...
    // Message.htmlJS互動彈窗
    let elmBtnMessageSubmit =document.querySelector('#btnMessageSubmit');
    if (elmBtnMessageSubmit)
    {
        elmBtnMessageSubmit.onclick=function () {
            window.alert('歡迎蒞臨本網站，您的寶貴意見我們會儘速處理與回覆，謝謝！')
        }; 
